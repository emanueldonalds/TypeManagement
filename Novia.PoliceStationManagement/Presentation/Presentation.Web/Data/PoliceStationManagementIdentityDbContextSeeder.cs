...
namespace Novia.PoliceStationManagement.Presentation.Web.Data
{
    public static class PoliceStationManagementIdentityDbContextSeeder
    {
        public static async Task SeedAsync(PoliceStationManagementIdentityDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
